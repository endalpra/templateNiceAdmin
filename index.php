...
URL::redirecionar("visoes/login.php");
            ...
            <aside>
                <div id="sidebar"  class="nav-collapse">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="">
                            <a class="" href="visoes/cadastrarpessoa.php">
                         ...
                         <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a class="" href="visoes/cadastrarlivro.php">Cadastrar</a></li>                          
                                <li><a class="" href="visoes/listarlivro.php">Listar</a></li>
                            </ul>
                        </li> 
                          <li class="sub-menu">
                            <a href="javascript:;" class="">
                            ...
                            <ul class="sub">
                                <li><a class="" href="visoes/cadastrarestante.php">Cadastrar</a></li>                          
                                <li><a class="" href="visoes/listarestante.php">Listar</a></li>
                            </ul>
                        </li> 
                         <li class="sub-menu">
                            <a href="javascript:;" class="">
                            ...
                            <ul class="sub">
                                <li><a class="" href="visoes/cadastrarprateleira.php">Cadastrar</a></li>                          
                                <li><a class="" href="visoes/listarprateleira.php">Listar</a></li>
                            </ul>
                        </li> 
                         <li class="sub-menu">
                            <a href="javascript:;" class="">
                            ...
                            <ul class="sub">
                                <li><a class="" href="visoes/cadastrarareadoconhecimento.php">Cadastrar</a></li>                          
                                <li><a class="" href="visoes/listarareadoconhecimento.php">Listar</a></li>
                            </ul>
                        </li> 
                    </ul>
                     sidebar menu end
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <span class="profile-ava pull-right">
                                                <img alt="" class="simple" src="template/img/avatar1_small.jpg">
                                                Jenifer smith
                                            </span>                                
                                        </div>
                                    </div>
