...
defined('QTD_PAG_PRATELEIRA') ? NULL : define('QTD_PAG_PRATELEIRA', '5');
defined('QTD_PAG_ESTANTE') ? NULL : define('QTD_PAG_ESTANTE', '5');
defined('QTD_PAG_LIVRO') ? NULL : define('QTD_PAG_LIVRO', '5');
?>