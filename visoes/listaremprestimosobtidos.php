...
if (isset($_SESSION['ses-usu-id'])) {
    ...
    <html lang="pt">
        ...
        <body onload="listarEmprestimosObtidos(0,<?= $_SESSION['ses-usu-id'] ?>)">
            ...
            <section id="container" class="">
                ...
                <section id="main-content">
                    <section class="wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="fa fa-exchange"></i>Empréstimos retirados</h3>
                                <!--                                <ol class="breadcrumb">
                                                                    <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                                                                    <li><i class="fa fa-exchange"></i>Empréstimos obtidos</li>
                                                                </ol>-->
                            </div>
                        </div>
                        ...
                        <div style="padding-left: 0!important" class="input-group col-xs-7"> 
                            ...
                            <input style="border:none;" class="form-control" id="pesquisar_emprestimo" name="pesquisar_emprestimo" onkeyup="listarEmprestimosObtidos(0,<?= $_SESSION['ses-usu-id'] ?>);" placeholder="Buscar meus emprestimos" type="text">
                        </div>                       



                        <div class="col-lg-2" style="float: right; margin-bottom: 4px; margin-top: -5px;">
                            <select onchange="listarEmprestimosObtidos(<?= $_SESSION['ses-usu-id'] ?>);" id="quantidade_emprestimos" style="margin-top: 9px;" class="form-control">
                                ...
                                <section class="panel">
                                    <header class="panel-heading tab-bg-info">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li onclick="listarEmprestimosObtidos(1,<?= $_SESSION['ses-usu-id'] ?>);">
