            ...
            <section id="container" class="">
                ...
                <section id="main-content">
                    <section class="wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"> <i class="icon_book_alt"></i> Cadastro de livro</h3>
                                <!--                                <ol class="breadcrumb">
                                                                    <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                                                                    <li><i class="fa fa-user-md"></i>Cadastrar livro</li>
                                                                </ol>-->
                            </div>
                        </div>
                        ...
                        if (isset($_POST['btCadastrar'])) {
                            ...
                            if (isset($msg) && $msg=="1"){//Se dados foram inseridos limpa os campos
                                $titulo = "";
                                ...
                                <section class="panel">
                                    <div class="panel-body">
                                        <div class="tab-content">
                                                            ...
                                                            <div id="edit-profile" class="tab-pane">
                                                                <section class="panel">                                          
                                                                    <div class="panel-body bio-graph-info">
                                                                        ...
                                                                        <form class="form-horizontal" action="cadastrarlivro.php" method="post" enctype="multipart/form-data">                                                  
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <select id="area_do_conhecimento" name="area_do_conhecimento" required="required" class="form-control m-bot15">
                                                                                        <?php
                                                                                        $selecionado = "";
                                                                                        echo " <option value=''>Selecione...</option>";
                                                                                        foreach ($areas_do_conhecimento as $a):
                                                                                            //Se dados não foram cadastrados, recarrega registro que estava selecionado
                                                                                            if ((isset($msgErro) && !empty($msgErro)) || (isset($msg) && $msg == "0")) {
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <select id="prateleira" name="prateleira" class="form-control m-bot15" required="required">
                                                                                        <?php
                                                                                        $selecionado = "";
                                                                                        echo " <option value=''>Selecione...</option>";
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <input type="text" onkeyup="autoCompletarAutor();" class="form-control" id="autor" name="autor" value="<?= @$autor ?>" required="required" placeholder="">
                                                                                    <input type="hidden" name="idautor" id="idautor" value="<?= @$idAutor ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="col-lg-2 control-label">Editora *</label>
                                                                                <div class="col-lg-6">
                                                                                    <input type="text" onkeyup="autoCompletarEditora();" class="form-control" id="editora" name="editora" value="<?= @$editora ?>" required="required" placeholder=" ">
                                                                                    <input type="hidden" name="ideditora" id="ideditora" value="<?= @$idEditora ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="control-label col-lg-2" for="inputSuccess">Lido</label>
                                                                                <div class="col-lg-10">
                                                                                    <div class="radio">
                                                                                        <label>
                                                                                            <input type="radio" name="lido" value="sim" checked>
                                                                                            Sim
                                                                                        </label>
                                                                                    </div>
                                                                                    <div class="radio">
                                                                                        <label>
                                                                                            <input type="radio" name="lido" value="nao">
                                                                                            Não
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="control-label col-lg-2" for="inputSuccess">Permitir busca online</label>
                                                                                <div class="col-lg-10">
                                                                                    <div class="radio">
                                                                                        <label>
                                                                                            <input type="radio" name="online" id="online" value="sim" checked>
                                                                                            Sim
                                                                                        </label>
                                                                                    </div>
                                                                                    <div class="radio">
                                                                                        <label>
                                                                                            <input type="radio" name="online" id="online" value="nao">
                                                                                            Não
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
                                            ...
                                            <div id="modalEditora" class="modal fade" role="dialog">
                                                <div class="modal-dialog modal-sm">
                                                    <!-- Modal content-->
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            <h3 class="modal-title">Editora inexistente. Por favor, cadastre-a.</h3>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="panel-body bio-graph-info">
                                                                <h1>Dados de Editora</h1>
                                                                <form class="form-horizontal" role="form" action="cadastrarlivro.php" method="post">                                                  
                                                                    <div class="form-group">
                                                                        <label class="col-lg-2 control-label">Nome</label>
                                                                        <div class="col-lg-6">
                                                                            <input type="text" class="form-control"  id="nomeEditora" required="required" placeholder="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="col-lg-offset-2 col-lg-10">
                                                                            <button type="button" onclick="cadastrarEditora();" class="btn btn-primary">Gravar</button>
                                                                        </div>
                                                                </form>    
                                                            </div>
                                        ...
                                        <div id="modalAutor" class="modal fade" role="dialog">
                                            <div class="modal-dialog modal-sm">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h3 class="modal-title">Autor inexistente. Por favor, cadastre-o.</h3>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="panel-body bio-graph-info">
                                                            ...
                                                            <form class="form-horizontal" role="form" action="cadastrarlivro.php" method="post">                                                  
                                                                <div class="form-group">
                                                                    <label class="col-lg-2 control-label">Nome</label>
                                                                    <div class="col-lg-6">
                                                                        <input type="text" class="form-control"  id="nomeAutor" required="required" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <div class="col-lg-offset-2 col-lg-10">
                                                                        <button type="button" onclick="cadastrarAutor();" class="btn btn-primary">Gravar</button>
                                                                    </div>
                                                            </form>    
                                                        </div>
                                                    ...
                                                    <p><?php
                                                        if (isset($msg)) {
                                                            if ($msg == 1) {
                                                                ...
                                                                echo "Problemas ao cadastrar livro";
                                                        }
                                    ...
                                    <!--Abre o aviso caso não existam prateleiras cadastradas-->
                                    ...
                                    if (count($prateleiras) == 0) {
                                        echo "<script>abrirNoty('Você não possui nenhuma prateleira cadastrada. Vá até o menu Minha prateleira e efetue o cadastro!')</script>";
                                    }
                                    ?>
                                    ...
                                    <!--Se livro já existe para este usuário não efetua o cadastro e avisa com Noty-->
                                    <?php
                                    if (isset($msgErroL) && $msgErroL == 10) {
                                        echo '<script>abrirNoty("Você já possui este título cadastrado!");'
                                        . '$("#titulo").css("border", "1px solid red");'
                                        . '$("#edicao").css("border", "1px solid red");</script>';
                                    }
                                    if (isset($msgErroL) && $msgErroL == 8) {
                                        echo '<script>abrirNoty("Você excedeu o limite de cadastros de livros! Para mais cadastros entre em contato com o suporte.")</script>';
                                    }
                                    ?>
