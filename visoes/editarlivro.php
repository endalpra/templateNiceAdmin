                ...
                <section id="main-content">
                    <section class="wrapper">
                        ...
                        if (isset($livros) && !empty($livros)) {
                            ...
                            $editora = $livros[0]->getNome_editora();
                            $ideditora = $livros[0]->getEditora();
                            $edicao = $livros[0]->getEdicao();
                            $isbn = $livros[0]->getIsbn();
                            $online = $livros[0]->getOnline();
                            $imagem = $livros[0]->getImagem();
                            $lido = $livros[0]->getLido();
                        }
                                                            ...
                                                            <div id="edit-profile" class="tab-pane">
                                                                <section class="panel">                                          
                                                                    <div class="panel-body bio-graph-info">
                                                                        ...
                                                                        <form class="form-horizontal" role="form" action="editarlivro.php" method="post" enctype="multipart/form-data">                                                  
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    ...
                                                                                    <input type="hidden" name="idautor" id="idautor" value="<?= @$idautor ?>">  </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-1">
                                                                                    <img width="50px" height="50px" src="../img/livros/<?= @$imagem ?>">
                                                                                </div>
                                                                                <div class="col-lg-5">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-10">
                                                                                    <div class="radio">
                                                                                        <label>
                                                                                            <input type="radio" name="lido" value="sim" <?php if ($lido == 1) echo 'checked'; ?> >
                                                                                            Sim
                                                                                        </label>
                                                                                    </div>
                                                                                    <div class="radio">
                                                                                        <label>
                                                                                            <input type="radio" name="lido" value="nao" <?php if ($lido == 0) echo 'checked'; ?>>
                                                                                            Não
                                                                                        </label>
                                                                                    </div>
                                                                                </div>
