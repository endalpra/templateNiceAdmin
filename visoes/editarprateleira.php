            ...
            <section id="container" class="">
                ...
                <section id="main-content">
                    <section class="wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="fa fa-user-md"></i> Edição de prateleira</h3>
                                <!--                                <ol class="breadcrumb">
                                                                    <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                                                                    <li><i class="fa fa-user-md"></i>Editar prateleira</li>
                                                                </ol>-->
                            </div>
                        </div>
                        ...
                        if (isset($prateleiras) && !empty($prateleiras)) {
                            $nome = $prateleiras[0]->getNome();
                            $estante = $prateleiras[0]->getEstante();
                        }
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p><?php
                                            if (isset($msg)) {
                                                if ($msg == 1)
                                                    echo "Prateleira editada com sucesso";
                                                else if ($msg == 0)
                                                    echo 'Erro ao editar';
                                            }
                        ...
                        <script>
                            $("#myModal").click(function () {
                                redirecionar("listarprateleiras.php");
                            });
                        </script>
                                                            ...
                                                            <div id="edit-profile" class="tab-pane">
                                                                <section class="panel">                                          
                                                                    <div class="panel-body bio-graph-info">
                                                                        ...
                                                                        <form class="form-horizontal" role="form" action="editarprateleira.php" method="post">                                                  
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <select id="estante" name="estante" required="" class="form-control m-bot15">
                                                                                        <?php
                                                                                        $selecionado = "";
                                                                                        echo " <option>Selecione...</option>";
                                                                                        foreach ($estantes as $e):
                                                                                            //Se dados não foram cadastrados, recarrega registro que estava selecionado
                                                                                            if ((isset($msgErro) && !empty($msgErro)) || (isset($msg) && $msg == "0") || isset($estante)) {
                                                                                                if ($estante == $e->getId()) {
                                                                            ...
                                                                            <input type="hidden" name="id" value="<?= $prateleiras[0]->getId(); ?>">
                                                                            <div class="form-group">
