            ...
            <section id="container" class="">
                ...
                <section id="main-content">  
                    <section class="wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="fa fa-exchange"></i> Empréstimos</h3>
                                <!--                                <ol class="breadcrumb">
                                                                    <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                                                                    <li><i class="fa fa-user-md"></i>Gerar empréstimo</li>
                                                                </ol>-->
                            </div>
                        </div>
                        <!-- page start-->
                                                            ...
                                                            <div id="edit-profile" class="tab-pane">
                                                                <section class="panel">                                          
                                                                    <div class="panel-body bio-graph-info">
                                                                        ...
                                                                        <form class="form-horizontal" role="form" action="geraremprestimo.php" method="post">                                                  

                                                                            <div class="form-group">
                                                                                <label class="control-label col-lg-2" for="inputSuccess">Título *</label>
                                                                                <div class="col-lg-6">
                                                                                    <select id="titulo" name="titulo" required="required" class="form-control m-bot15">
                                                                                        <?php
                                                                                        $selecionado = "";
                                                                                        echo " <option value=''>Selecione...</option>";
                                                                                        foreach ($titulos as $t):
                                                                                            //Se dados não foram cadastrados, recarrega registro que estava selecionado
                                                                                            if ((isset($msgErro) && !empty($msgErro)) || (isset($msg) && $msg == "0") || isset($titulo)) {
                                                                                                if ($titulo == $t->getId()) {
                                                                                                    $selecionado = "selected";
                                                                                                }
                                                                                                echo " <option value='{$t->getId()}'" . $selecionado . ">{$t->getTitulo()}</option> ";
                                                                                                $selecionado = "";
                                                                                            } else {
                                                                                                echo " <option value='{$t->getId()}'>{$t->getTitulo()}</option> ";
                                                                                            }
                                                                                        endforeach;
                                                                                        ?>                                                                                    
                                                                                    </select>                                                                                
                                                                            ...
                                                                            <!--<div class="form-group">
                                                                                <label class="control-label col-lg-2" for="inputSuccess">Pessoa *</label>
                                                                                <div class="col-lg-6">
                                                                                    <select id="pessoa" name="pessoa" class="form-control m-bot15" required="">
                                                                            <?php /*
                                                                              $selecionado = "";
                                                                              echo " <option>Selecione...</option>";
                                                                              foreach ($pessoas as $p):
                                                                              //Se dados não foram cadastrados, recarrega registro que estava selecionado
                                                                              if ((isset($msgErro) && !empty($msgErro)) || (isset($msg) && $msg == "0") || isset($pessoa)) {
                                                                              if ($pessoa == $p->getId()) {
                                                                              $selecionado = "selected";
                                                                              }
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label class="col-lg-2 control-label">Pessoa *</label>
                                                                                <div class="col-lg-6">
                                                                                    <input type="text" required="required" onkeyup="autoCompletarPessoa();" class="form-control" id="pessoa" name="pessoa" value="<?= @$pessoa ?>"  placeholder="">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <input type="text" class="form-control calendario"  name="data" value="<?= @$data ?>" required="required" placeholder="">
                                                                                </div>
                                                                            </div>

                                                                            <div class="form-group">
                                                                                <label class="col-lg-2 control-label">Data prevista</label>
                                                                                <div class="col-lg-6">
                                                                                    <input type="text" class="form-control calendario" name="data_prevista" value="<?= @$data_prevista ?>"  placeholder=" ">
                                                                                </div>
                                                                            </div> 
                                                                            <div class="form-group">
                                                                                <label class="col-lg-2 control-label">Observação</label>
                                                                                <div class="col-lg-6">
                                                                                    <textarea name="observacao" id="observacao" class="form-control" cols="30" rows="5"><?= @$observacao ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p><?php
                                                                        if (isset($msg))
                                                                            echo "Empréstimo gerado com sucesso";
