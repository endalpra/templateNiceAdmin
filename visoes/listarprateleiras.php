            ...
            <section id="container" class="">
                ...
                <section id="main-content">
                    <section class="wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="icon_table"></i></i> Minhas prateleiras</h3>
                                <!--                                <ol class="breadcrumb">
                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                        ...
                                        <tbody class="paginacao_ajax">
                                            ...
                                            if (count($prateleiras) > 0) {
                                                foreach ($prateleiras as $p):
                                                    ...
                                                    <tr data-cod="<?= $p->getId() ?>">
                                                        ...
                                                        <td style="text-align: left">
                                                            <div class="btn-group">
                                                                <a class="btn btn-primary" title="Editar" data-placement="bottom" href="editarprateleira.php?id=<?= $p->getId(); ?>"><i class="icon_pencil"></i></a>
                                                                <a class="btn btn-danger " title="Excluir" data-placement="bottom" onclick="excluirPrateleira(<?= $p->getId(); ?>,<?php echo $_SESSION['ses-usu-id'] ?>)" href="#"><i class="icon_close_alt2"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                ...
                                                echo '<tr><td colspan="3"><h3>Nenhum registro para mostrar!</h3></td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
