            ...
            <section id="container" class="">
                ...
                <section id="main-content">
                    <section class="wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="fa fa-user-md"></i> Perfil de usuário</h3>
                                <!--                                <ol class="breadcrumb">
                                                                    <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                                                                    <li><i class="fa fa-user-md"></i>Perfil pessoa</li>
                                                                </ol>-->
                            </div>
                        </div>
                        ...
                        <?php
                        require_once '../controles/pessoa.php';
                        if (isset($pessoa)) {
                            foreach ($pessoa as $p):
                                $id = $p->getId();
                                $nome = $p->getNome();
                                ...
                                $confiabilidade = ($p->getConfiabilidade() * 30);
                            endforeach;
                        }
                        ?>
                        ...
                        <section style="background: white">
                            ...
                            <div class="row container">                            
                                <div class="col-lg-4">
                                    <table class="table table-inbox" style="border: none;margin-top: -35px !important;">
                                        <tr><td style="border-top: none; cursor: default !important;"><h3>Nome</h3><?= @$nome ?></td></th>
                                        <!--<tr><td style="border-top: none; cursor: default !important;"><?= @$email ?></td></tr>-->
                                        <tr><td style="border-top: none; cursor: default !important;"><h3 style="margin-top: -8px;">Distância</h3><?= @$distancia ?> Km</td></tr>
                                        <!--<tr><td style="border-top: none; cursor: default !important;"><?= @$confiabilidade ?></td></tr>-->
                                        <tr><td style="border-top: none; cursor: default !important;"><h3 style="margin-top: -8px">Avaliação</h3>
                                                <div class="barra">
                                                    <span class="bg"></span>
                                                    <div class="estrelas">
                                        ...
                                        <?php
                                        if ($id != $_SESSION['ses-usu-id']) {
                                            ?>
                                            <tr>
                                                <td style="border-top: none"><h3 style="margin-top: -8px">Mensagem</h3><div class="btn-group" onclick="$('#myModal').modal('show');"><a class="btn btn-success " title="Contatar dono" data-placement="bottom" ><i class="icon_mail_alt"></i></a></div></td>
                                            </tr>         
                                            <?php
                                        }
                                        ?>
                                ...
                                <div class="col-lg-6">
                                    <img class="img-responsive img-rounded" style='max-height: 400px' src="../img/pessoas/<?php echo $imagem != '' ? $imagem : 'sem_imagem.jpg' ?>">
                                </div>                           
                            </div>

                            <!--  <div class="row container" style="background: white;">
                                      <div class="col-lg-12">
                                          <table class="table-bordered" id="comentarios" style="width: 100%;margin-top: 20px;">
                            ...
                            <hr style="border: 0.5px solid #f1f1f1; width: 98%">                          
                            ...
                            <div class="modal-body">
                                <div class="panel-body bio-graph-info">
                                    <div class="col-md-12">
                                        ...
                                        <button type="submit" onclick="enviarMensagem($('#conteudoMsg').val(),<?= @$_SESSION['ses-usu-id'] ?>, <?= @$id ?>, 1)" class="btn btn-info">Enviar</button>
                                    </div>  
                                </div>
                            </div>
                        </div>
                ...
                <script>
                                            ...
                                            listarComentariosPerfilPessoa(<?php echo $id ?>);
                </script>
                <script>
