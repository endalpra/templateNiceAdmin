        ...
        <section id="container" class="">
                ...
                <div id="sidebar"  class="nav-collapse">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="active">
                            <a class="" href="">
                                <i class="icon_document_alt"></i>
                                <span>Cadastrar área do conhecimento</span>
                            </a>
                        </li>
                        <li class="sub-menu">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-user-md"></i> Cadastro de área do conhecimento</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="../index.php">Home</a></li>
                                <li><i class="fa fa-user-md"></i>Cadastrar área do conhecimento</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    if (isset($_POST['btCadastrar'])) {
                        require_once (__DIR__ . '/../controles/area_do_conhecimento.php');
                        if (isset($msg)) {
                            echo $msg;
                                                        ...
                                                        <div id="edit-profile" class="tab-pane">
                                                            <section class="panel">                                          
                                                                <div class="panel-body bio-graph-info">
                                                                    <h1>Dados da área do conhecimento</h1>
                                                                    <form class="form-horizontal" role="form" action="cadastrarareadoconhecimento.php" method="post">                                                  
                                                                        ...
                                                                        <input type="hidden" name="pessoa" value="<?php echo $_SESSION['ses-cod-usu']?>">
                                                                        <div class="form-group">
