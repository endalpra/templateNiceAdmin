            ...
            <section id="container" class="">
                ...
                <section id="main-content">
                    <section class="wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"> <i class="icon_book_alt"></i> Meus livros</h3>
                                <!--                                <ol class="breadcrumb">
                            ...
                            <div class="col-lg-12">
                                <section class="panel">
                                    ...
                                    <div style="padding-left: 0!important" class="input-group col-xs-7"> 
                                        ...
                                        <input style="border:none;" class="form-control" id="pesquisar_titulo_" name="pesquisar_titulo_" onkeyup="listarLivros(0,<?= $_SESSION['ses-usu-id'] ?>);" placeholder="Buscar meus livros" type="text">
                                    </div>                       



                                    <div class="col-lg-2" style="float: right; margin-bottom: 4px; margin-top: -5px;">
                                        <select onchange="listarLivros(0,<?= $_SESSION['ses-usu-id'] ?>);" id="quantidade_titulos" style="margin-top: 9px;" class="form-control">
                                            <option value="7">7 livros por página</option>
                ...
                <div id="myModalDetalhesLivro" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-detalhes-livro">
                        <!-- Modal content-->
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="panel-body bio-graph-info">
                                    <div class="col-md-12">
                                        <div class="col-lg-6" id="detalhes_livro"></div>
                                        <div class="col-lg-6" id="detalhes_imagem"></div>
                                    </div>  
                                </div>
                            </div>
