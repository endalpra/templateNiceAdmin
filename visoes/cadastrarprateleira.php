            ...
            <section id="container" class="">
                ...
                <section id="main-content">
                    <section class="wrapper">
                        <div class="row">
                            <div class="col-lg-12">
                                <h3 class="page-header"><i class="icon_table"></i></i> Cadastro de prateleira</h3>
                                <!--                                <ol class="breadcrumb">
                                                                    <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
                                                                    <li><i class="fa fa-user-md"></i>Cadastrar prateleira</li>
                                                                </ol>-->
                            </div>
                        </div>
                                                            ...
                                                            <div id="edit-profile" class="tab-pane">
                                                                <section class="panel">                                          
                                                                    <div class="panel-body bio-graph-info">
                                                                        <h1>Dados da prateleira</h1>
                                                                        <form class="form-horizontal" role="form" action="cadastrarprateleira.php" method="post">                                                  
                                                                            <div class="form-group">
                                                                                <label class="col-lg-2 control-label">Nome *</label>
                                                                                <div class="col-lg-6">
                                                                                    <input type="text" class="form-control" id="nome" name="nome" required="required" value="<?= @$nome ?>" placeholder=" ">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label class="control-label col-lg-2" for="inputSuccess">Estante *</label>
                                                                                <div class="col-lg-6">
                                                                                    <select id="estante" name="estante" required="required" class="form-control m-bot15">
                                                                                        <?php
                                                                                        $selecionado = "";
                                                                                        ...
                                                                                        foreach ($estantes as $e):
                                                                                            ...
                                                                                            if ((isset($msgErro) && !empty($msgErro)) || (isset($msg) && $msg == "0")) {
                                                                                                ...
                                                                                                echo " <option value='{$e->getId()}'" . $selecionado . ">{$e->getNome()}</option> ";
                                                                                                $selecionado = "";
                                                                                            } else {
                                                                            ...
                                                                            <input type="hidden" name="pessoa" value="<?php echo $_SESSION['ses-usu-id'] ?>">
                                                                            <div class="form-group">
                    ...
                    <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p><?php
                                    if (isset($msg))
                                        echo "Prateleira cadastrada com sucesso";
                ...
                <!--Abre aviso caso não existam estantes cadastradas-->
                ...
                <?php
                if (count($estantes) == 0) {
                    echo "<script>abrirNoty('Você não possui nenhuma estante cadastrada. Vá até o menu Minha estante e efetue o cadastro!')</script>";
                }
                ?>
